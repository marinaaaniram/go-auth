...
import (
	...
	"go-auth/internal/api/access"
	"go-auth/internal/api/auth"
	...
	accessRepository "go-auth/internal/repository/access/pg"
	accessRedisRepository "go-auth/internal/repository/access/redis"
