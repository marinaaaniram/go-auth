...
func (mmGetAuthInfo *mUserRepositoryMockGetAuthInfo) Expect(ctx context.Context, auth *model.AuthInput) *mUserRepositoryMockGetAuthInfo {
	...
	mmGetAuthInfo.defaultExpectation.params = &UserRepositoryMockGetAuthInfoParams{ctx, auth}
...
func (mmGetAuthInfo *mUserRepositoryMockGetAuthInfo) ExpectAuthParam2(auth *model.AuthInput) *mUserRepositoryMockGetAuthInfo {
	...
	mmGetAuthInfo.defaultExpectation.paramPtrs.auth = &auth
	mmGetAuthInfo.defaultExpectation.expectationOrigins.originAuth = minimock.CallerInfo(1)
...
func (mmGetAuthInfo *mUserRepositoryMockGetAuthInfo) Return(up1 *model.User, err error) *UserRepositoryMock {
	if mmGetAuthInfo.mock.funcGetAuthInfo != nil {
		mmGetAuthInfo.mock.t.Fatalf("UserRepositoryMock.GetAuthInfo mock is already set by Set")
	}
	...
	mmGetAuthInfo.defaultExpectation.results = &UserRepositoryMockGetAuthInfoResults{up1, err}
...
func (mmGetAuthInfo *mUserRepositoryMockGetAuthInfo) When(ctx context.Context, auth *model.AuthInput) *UserRepositoryMockGetAuthInfoExpectation {
	...
	expectation := &UserRepositoryMockGetAuthInfoExpectation{
		...
		params:             &UserRepositoryMockGetAuthInfoParams{ctx, auth},
...
func (e *UserRepositoryMockGetAuthInfoExpectation) Then(up1 *model.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetAuthInfoResults{up1, err}
	return e.mock
}
...
func (mmGetAuthInfo *UserRepositoryMock) GetAuthInfo(ctx context.Context, auth *model.AuthInput) (up1 *model.User, err error) {
	...
	if mmGetAuthInfo.inspectFuncGetAuthInfo != nil {
		mmGetAuthInfo.inspectFuncGetAuthInfo(ctx, auth)
	}

	mm_params := UserRepositoryMockGetAuthInfoParams{ctx, auth}
	...
	if mmGetAuthInfo.GetAuthInfoMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockGetAuthInfoParams{ctx, auth}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.auth != nil && !minimock.Equal(*mm_want_ptrs.auth, mm_got.auth) {
				mmGetAuthInfo.t.Errorf("UserRepositoryMock.GetAuthInfo got unexpected parameter auth, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetAuthInfo.GetAuthInfoMock.defaultExpectation.expectationOrigins.originAuth, *mm_want_ptrs.auth, mm_got.auth, minimock.Diff(*mm_want_ptrs.auth, mm_got.auth))
			}
	...
	if mmGetAuthInfo.funcGetAuthInfo != nil {
		return mmGetAuthInfo.funcGetAuthInfo(ctx, auth)
	}
	mmGetAuthInfo.t.Fatalf("Unexpected call to UserRepositoryMock.GetAuthInfo. %v %v", ctx, auth)
	return
}
